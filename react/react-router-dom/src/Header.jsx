...
export default function Header() {
  ...
  return (
    <header class='flex bg-white border-b py-4 sm:px-8 px-6 font-[sans-serif] min-h-[80px] tracking-wide relative z-50 sticky top-0'>
        ...
        <div class='flex items-center space-x-8'>
          ...
          <Link to="/carts">
            <span class="relative">
              ...
              <span class="absolute left-auto -ml-1 top-0 rounded-full bg-red-500 px-1 py-0 text-xs text-white">{ cartItems.length }</span>
            </span>
          </Link>
          <button
