                ...
                <div class="w-full min-h-[610px]">
                    <div class="max-w-[1220px] mx-auto py-5">
                        ...
                        <div class="mb-5">
                                ...
                                <select id="default" name="Root_id" onChange={id} class="border-2 border-gray-300 text-gray-900 mb-6 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3">
                            ...
                            <div class="mb-5">
                                ...
                                <select id="default" name="subParentCatSelectBox" class="border-2 border-gray-300 text-gray-900 mb-6 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3">
                            ...
                            <div class="mb-5">
                                <div class="grid sm:grid-cols-2 gap-8">
                                    <div>
                                        ...
                                        <select id="default" name="pdSizeSelectBox" class="border-2 border-gray-300 text-gray-900 mb-6 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3">
                                    ...
                                    <div>
                                        ...
                                        <select id="default" name="pdColorSelectBox" class="border-2 border-gray-300 text-gray-900 mb-6 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3">
