        ...
        <>
            <div class="w-full">
                <div class="max-w-[1220px] mx-auto py-5">
                    ...
                    <form class="p-3 border border-t-0 rounded-b-md border-slate-400">
                        <div class="grid grid-cols-2">
                            <div>
                                ...
                                <br />
                                <div>
                                    <label for="base-input" class="block mb-5 text-md font-medium text-gray-900">Social Links</label>
                                    <div class="space-y-9">
                                        <div class="flex">
                                            <span class="inline-flex items-center px-3 text-sm">
                                                <svg fill="black" class="w-5 h-5 me-1 text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
                                        ...
                                        <div class="flex">
                                            <span class="inline-flex items-center px-3 text-sm">
                                                <svg fill="black" class="w-5 h-5 me-1 text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                                    <path
                                        ...
                                        <div class="flex">
                                            <span class="inline-flex items-center px-3 text-sm">
                                                <svg fill="black" class="w-5 h-5 me-1 text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                                    <path
                                        ...
                                        <div class="flex">
                                            <span class="inline-flex items-center px-3 text-sm">
                                                <svg fill="black" class="w-5 h-5 me-1 text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                    ...
                                    <div class="mb-5">
                                        <label for="base-input" class="block my-8 text-md font-medium text-gray-900">Logo</label>
                                        <img
                                            class="w-20 border-black border-2 shadow-md rounded-md"
                                    ...
                                    <div class="mb-5">
                                        <label for="base-input" class="block my-8 text-md font-medium text-gray-900">Sub Logo</label>
                                        <img
                                            class="w-20 border-black border-2 shadow-md rounded-md"
                                    ...
                                    <div class="mb-5">
                                        <label for="base-input" class="block my-8 text-md font-medium text-gray-900">Sub Logo</label>
                                        <div class="grid gap-3 grid-cols-[80%_auto] items-baseline">
                                            <input
                                                type="password"
                                                name="changePassword"
                                                id="password"
                            ...
                            <div class="pt-16 flex items-center justify-start flex-col">
                                <figure><img class="rounded-full w-40 h-40 border-2 object-cover shadow-lg" src="https://images.pexels.com/photos/2379005/pexels-photo-2379005.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=1&amp;w=500" alt="" /></figure>
